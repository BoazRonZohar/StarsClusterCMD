...
def _set_params_by_type_and_distance(cluster_type: str, dist_pc: float):
    ...
    if cluster_type.upper() == 'G':
        ...
        g['MATCH_MAX_ARCSEC']   = 2.0
        g['PARALLAX_MIN_HALF']  = 0.05
        g['PARALLAX_MAX_HALF']  = 5.00
        g['PARALLAX_FRAC']      = 100.0
        g['PARALLAX_ERR_SIGMA'] = 5.0
        g['PM_SIGMA_FLOOR']     = 1.5
        g['PM_ERR_SIGMA']       = 8.0
        g['PM_CHI2']            = 40.0
        g['SPATIAL_CORE_FRAC']  = 0.15
        g['ALIGN_SEARCH_ARCSEC'] = 60.0
        g['ALIGN_MIN_PAIRS']     = 20
    else:
        # Open cluster: looser windows
        g['MATCH_MAX_ARCSEC']   = 3.0
        g['PARALLAX_MIN_HALF']  = 0.20
        g['PARALLAX_MAX_HALF']  = 2.00
        g['PARALLAX_FRAC']      = 100.0
        g['PARALLAX_ERR_SIGMA'] = 6.0
        g['PM_SIGMA_FLOOR']     = 1.0
        g['PM_ERR_SIGMA']       = 5.0
        g['PM_CHI2']            = 50.0
        g['SPATIAL_CORE_FRAC']  = 0.20
        g['ALIGN_SEARCH_ARCSEC'] = 60.0
        g['ALIGN_MIN_PAIRS']     = 20

# Apply profile
_set_params_by_type_and_distance(cluster_type, CLUSTER_DISTANCE_PC)
MATCH_MAX_ARCSEC   = 10.0
